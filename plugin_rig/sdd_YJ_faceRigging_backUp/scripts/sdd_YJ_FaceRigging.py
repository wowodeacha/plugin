...
def sdd_FaceRigging(rootPath):
    ...
    cmds.button('frSnapCtrlB', w=223, l='Create Snap Ctrl', c='NCM.create_face_snap_ctrl(0)')
    cmds.button('frSnapMatchB', w=223, l='Match To Clost Point', c='NCM.match_ctrl_mesh(0)')
    cmds.rowLayout(p='frSnapCtrlCL', nc=4)
    cmds.button('frSnapCtrlMirB', w=223, l='L>>R Mir', c='NCM.mirrorCtrlPos("L>>R")')
    cmds.button('frSnapRigB', w=223, l='Set Up To Snap Ctrl', c='NCM.set_up_snap_ctrl(0)')
