...
"color: rgb(255, 255, 255);"))
        ...
        self.createheadmeshgrp_pushButton.setStyleSheet(_fromUtf8("background-color: rgb(138, 141, 156);"))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 376, 245))
