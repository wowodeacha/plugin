...
class Ui_faceUI_Form(object):
    def setupUi(self, faceUI_Form):
        ...
        self.gridLayout_5.addWidget(self.rebulidAllBone_pushButton, 4, 0, 1, 1)
        self.bneMir_pushButton = QtGui.QPushButton(self.groupBox_2)
        self.bneMir_pushButton.setObjectName(_fromUtf8("bneMir_pushButton"))
        self.gridLayout_5.addWidget(self.bneMir_pushButton, 3, 0, 1, 1)
        self.gridLayout_18 = QtGui.QGridLayout()
        self.gridLayout_18.setObjectName(_fromUtf8("gridLayout_18"))
        self.createheadmeshgrp_pushButton = QtGui.QPushButton(self.groupBox_2)
        self.createheadmeshgrp_pushButton.setStyleSheet(_fromUtf8("\n"
"background-color: rgb(75, 78, 99);"))
        self.createheadmeshgrp_pushButton.setObjectName(_fromUtf8("createheadmeshgrp_pushButton"))
        self.gridLayout_18.addWidget(self.createheadmeshgrp_pushButton, 0, 0, 1, 1)
        ...
        self.gridLayout_18.addWidget(self.setheadmesh_pushButton, 1, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 389, 245))
        ...
        self.page_4.setGeometry(QtCore.QRect(0, 0, 369, 69))
        ...
        self.page_5.setGeometry(QtCore.QRect(0, 0, 369, 69))
        ...
        self.page_6.setGeometry(QtCore.QRect(0, 0, 369, 69))
        ...
        self.page_7.setGeometry(QtCore.QRect(0, 0, 369, 69))
        ...
        self.page_8.setGeometry(QtCore.QRect(0, 0, 369, 69))
        ...
        self.page_9.setGeometry(QtCore.QRect(0, 0, 369, 69))
        ...
        self.gridLayout_18.addWidget(self.scrollArea, 2, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.snapForeHeadMeshToHeadMesh_pushButton, 2, 0, 1, 1)
    ...
    def retranslateUi(self, faceUI_Form):
        ...
        self.createheadmeshgrp_pushButton.setText(_translate("faceUI_Form", "生成头部模型组", None))
        self.setheadmesh_pushButton.setText(_translate("faceUI_Form", "设置模型", None))
